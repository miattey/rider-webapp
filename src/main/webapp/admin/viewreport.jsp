    ...
    <div class="container mt-3">
                <div class="row">
                    <div class="col-md-2 mb-2">
                        <a  role="button" class="btn btn-danger" href="generatereport">Back</a>
                    </div>
                </div>
        ...
        <c:when test="${not empty dailybookings}">
            ...
            <div class="row">
                <div class="col-md-6 p-3 bg-body shadow-sm">
                    ...
                    <!-- Heading -->
                    <span class="h2 mb-0">
                       <c:out value="${driverdetails.firstName}"/>  <c:out value="${driverdetails.lastName}"/> <span class="badge bg-warning">   <c:out value="${driverdetails.reg}"/></span>
                    </span>
                ...
                <div class="col-md-6 p-3 bg-body shadow-sm">
                        ...
                        <span class="h2 mb-0">
                            <span class="fs-6" >MVR</span> <c:out value="${totalTurnover}" />
                        </span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 p-3 bg-body shadow-sm  mt-2">
                    <h6 class="text-uppercase text-muted mb-2">Total Customers Served</h6>
                    <span class="h2 mb-0"><c:out value="${totalserved}" /></span>
                </div>
            </div>
    ...
    <div class="container mt-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="container mt-3 p-3 bg-body rounded shadow-sm">
            <div class="alert alert-warning d-flex alight-items-center" role="alert">
                <div>No booking for the day for the selected driver</div>
            </div>
        </div>
        </c:when>
        </c:choose>
